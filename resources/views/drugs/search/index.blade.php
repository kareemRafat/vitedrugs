...
@section('title', __('drugs.search.title'))
    ...
    <div class="space-y-4">
        ...
        @if (filled($query))
            ...
            <div class="bg-neutral-primary-soft rounded-base shadow-xs px-5 py-4 dark:bg-slate-800">
                <h2 class="text-base font-semibold text-heading dark:text-white">{{ __('drugs.search.results_for', ['q' => $query]) }}</h2>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="bg-neutral-primary-soft rounded-base shadow-xs dark:bg-slate-800 overflow-hidden">
                    <div class="px-5 py-4 border-b border-default-medium flex items-center gap-2">
                        ...
                        <h2 class="text-base font-semibold text-heading dark:text-white">{{ __('drugs.search.diseases') }}</h2>
                    ...
                    <div class="p-5">
                        @forelse ($diseases as $item)
                            <div class="flex items-center justify-between py-2 border-b border-default-medium last:border-0">
                                <a href="{{ route('drugs.diseases.show', $item->slug) }}" wire:navigate class="text-base font-medium text-fg-brand hover:underline">{{ $item->name }}</a>
                                <a href="{{ route('drugs.diseases.show', $item->slug) }}" wire:navigate
                        ...
                        @empty
                            <p class="text-base text-body dark:text-slate-400 text-center py-4">{{ __('drugs.search.no_section_results') }}</p>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="bg-neutral-primary-soft rounded-base shadow-xs dark:bg-slate-800 overflow-hidden">
                    <div class="px-5 py-4 border-b border-default-medium flex items-center gap-2">
                        ...
                        <h2 class="text-base font-semibold text-heading dark:text-white">{{ __('drugs.search.clinical_signs') }}</h2>
                    ...
                    <div class="p-5">
                        @forelse ($clinicalSigns as $item)
                            <div class="py-2 border-b border-default-medium last:border-0">
                                <a href="{{ route('drugs.diagnosis', ['sign' => $item->id]) }}" wire:navigate class="text-base font-medium text-fg-brand hover:underline">{{ $item->display_name }}</a>
                ...
                <div class="bg-neutral-primary-soft rounded-base shadow-xs dark:bg-slate-800 overflow-hidden">
                    <div class="px-5 py-4 border-b border-default-medium flex items-center gap-2">
                        ...
                        <h2 class="text-base font-semibold text-heading dark:text-white">{{ __('drugs.search.products') }}</h2>
                ...
                <div class="bg-neutral-primary-soft rounded-base shadow-xs dark:bg-slate-800 overflow-hidden">
                    <div class="px-5 py-4 border-b border-default-medium flex items-center gap-2">
                        ...
                        <h2 class="text-base font-semibold text-heading dark:text-white">{{ __('drugs.search.blog_articles') }}</h2>
                ...
                <div class="bg-neutral-primary-soft rounded-base shadow-xs dark:bg-slate-800 overflow-hidden">
                    <div class="px-5 py-4 border-b border-default-medium flex items-center gap-2">
                        ...
                        <h2 class="text-base font-semibold text-heading dark:text-white">{{ __('drugs.search.microorganisms') }}</h2>
                    ...
                    <div class="p-5">
                        @forelse ($microorganisms as $item)
                            <div class="flex items-center justify-between py-2 border-b border-default-medium last:border-0">
                                <a href="{{ route('drugs.microorganisms.show', $item->slug) }}" wire:navigate class="text-base font-medium text-fg-brand hover:underline">{{ $item->name }}</a>
                                <a href="{{ route('drugs.microorganisms.show', $item->slug) }}" wire:navigate
                                    class="inline-flex items-center justify-center w-8 h-8 text-white bg-brand hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium rounded-base text-sm shrink-0">
                                    <x-lucide-arrow-right class="w-4 h-4 rtl:rotate-180" />
                                </a>
                            </div>
                ...
                <div class="bg-neutral-primary-soft rounded-base shadow-xs dark:bg-slate-800 overflow-hidden">
                    <div class="px-5 py-4 border-b border-default-medium flex items-center gap-2">
                        ...
                        <h2 class="text-base font-semibold text-heading dark:text-white">{{ __('drugs.search.medical_articles') }}</h2>
                    ...
                    <div class="p-5">
                        @forelse ($medicalArticles as $item)
                            <div class="flex items-center justify-between py-2 border-b border-default-medium last:border-0">
                                <a href="{{ route('drugs.medical-articles.show', $item->slug) }}" wire:navigate class="text-base font-medium text-fg-brand hover:underline">{{ $item->title }}</a>
                                <a href="{{ route('drugs.medical-articles.show', $item->slug) }}" wire:navigate
                                    class="inline-flex items-center justify-center w-8 h-8 text-white bg-brand hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium rounded-base text-sm shrink-0">
                                    <x-lucide-arrow-right class="w-4 h-4 rtl:rotate-180" />
                                </a>
                            </div>
        ...
        @else
            ...
            <div class="bg-neutral-primary-soft rounded-base shadow-xs p-12 text-center dark:bg-slate-800">
                ...
                <h2 class="text-xl font-semibold text-heading dark:text-white mb-2">{{ __('drugs.search.heading') }}</h2>
                <p class="text-base text-body dark:text-slate-400">{{ __('drugs.search.no_query') }}</p>
            </div>
