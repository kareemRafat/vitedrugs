    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 py-16 sm:py-28 text-center">
            ...
            <div class="mt-9 flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="{{ route('drugs.home') }}" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-brand hover:bg-brand-strong rounded-base shadow-lg shadow-brand/25 transition-all active:scale-95">
    ...
    <section class="px-4 pb-16 sm:pb-24">
        <div class="max-w-7xl mx-auto">
            <div class="rounded-2xl sm:rounded-3xl bg-gradient-to-br from-brand via-brand-strong to-brand-strong p-6 sm:p-10 text-center">
                ...
                <a href="{{ route('large-animals.home') }}" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold bg-white text-brand-strong rounded-full hover:bg-white/90 transition-all">
                    Back to Large Animals
                </a>
            </div>
        </div>
    </section>
