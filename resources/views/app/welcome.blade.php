...
@section('title', __('messages.welcome.title'))
    ...
    <div class="w-full max-w-md p-6 bg-neutral-primary-soft rounded-base shadow-xs dark:bg-gray-800 sm:p-8">
        <div class="text-center">
            ...
            <h2 class="text-2xl font-bold text-heading dark:text-white mb-2">
                {{ __('messages.welcome.heading', ['app' => config('app.name', 'VetPedia')]) }}
            </h2>
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('register') }}"
                    ...
                    {{ __('messages.welcome.create_account') }}
                </a>
                ...
                <div class="relative my-4">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-neutral-primary-soft dark:bg-gray-800 text-body dark:text-gray-400">{{ __('messages.welcome.or') }}</span>
                    </div>
                </div>
                ...
                <a href="{{ route('home') }}"
                    ...
                    {{ __('messages.welcome.continue_as_guest') }}
                </a>
            </div>
        </div>
    </div>
