...
@section('content')
    <div class="w-full max-w-md p-6 bg-neutral-primary-soft rounded-base shadow-xs dark:bg-slate-800 sm:p-8">
        <div class="flex flex-col items-center text-center mb-6">
            ...
            <p class="mt-2 text-sm text-body dark:text-slate-400 max-w-xs">
        ...
        <p class="mb-6 text-sm text-body dark:text-slate-400 leading-relaxed">
