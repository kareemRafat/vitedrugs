        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
                <a href="{{ route('large-animals.home') }}"
                    class="group relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 dark:border-slate-700/50 bg-white dark:bg-slate-800/50 backdrop-blur-xl p-5 sm:p-7 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-orange-400/40">
                    <div class="mx-auto w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center mb-4 sm:mb-5 shadow-lg shadow-orange-500/25 sm:group-hover:scale-110 sm:group-hover:-rotate-3 transition-all duration-300">
                ...
                <a href="{{ route('drugs.home') }}"
                    class="group relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 dark:border-slate-700/50 bg-white dark:bg-slate-800/50 backdrop-blur-xl p-5 sm:p-7 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-indigo-500/40 hover:border-indigo-400/40">
                    <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-indigo-500 to-sky-500 flex items-center justify-center mx-auto mb-4 sm:mb-5 shadow-lg shadow-indigo-500/25 sm:group-hover:scale-110 sm:group-hover:-rotate-3 transition-all duration-300">
