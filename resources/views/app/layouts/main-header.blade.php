    ...
    <div class="px-3 py-3 lg:px-5">
        <div class="flex items-center justify-between sm:grid sm:grid-cols-3 sm:items-center">
            ...
            <div class="hidden sm:flex items-center justify-center gap-1">
                <a href="{{ route('products.index') }}" @class(['px-2 py-1 text-sm font-medium rounded-base transition-colors duration-150', 'text-fg-brand font-semibold' => request()->routeIs('products.*'), 'text-body hover:text-fg-brand dark:text-slate-400 dark:hover:text-white' => !request()->routeIs('products.*')])>{{ __('messages.nav.products') }}</a>
                <a href="{{ route('diseases.index') }}" @class(['px-2 py-1 text-sm font-medium rounded-base transition-colors duration-150', 'text-fg-brand font-semibold' => request()->routeIs('diseases.*'), 'text-body hover:text-fg-brand dark:text-slate-400 dark:hover:text-white' => !request()->routeIs('diseases.*')])>{{ __('messages.nav.diseases') }}</a>
                ...
                <a href="{{ route('companies.index') }}" @class(['px-2 py-1 text-sm font-medium rounded-base transition-colors duration-150', 'text-fg-brand font-semibold' => request()->routeIs('companies.*'), 'text-body hover:text-fg-brand dark:text-slate-400 dark:hover:text-white' => !request()->routeIs('companies.*')])>{{ __('messages.nav.companies') }}</a>
                <a href="{{ route('blog.index') }}" @class(['px-2 py-1 text-sm font-medium rounded-base transition-colors duration-150', 'text-fg-brand font-semibold' => request()->routeIs('blog.*'), 'text-body hover:text-fg-brand dark:text-slate-400 dark:hover:text-white' => !request()->routeIs('blog.*')])>{{ __('messages.nav.blog') }}</a>
            ...
            <div class="flex items-center justify-end gap-1 sm:gap-2">
                <a href="{{ route('search') }}" class="text-body hover:text-fg-brand dark:text-slate-400 dark:hover:text-white p-2 rounded-base" title="{{ __('messages.nav.search') }}">
...
{{-- Mobile sidebar --}}
<div id="mobileSidebar" class="fixed top-0 start-0 z-50 w-full h-screen bg-neutral-primary-soft dark:bg-slate-800 translate-x-[-100%] rtl:translate-x-[100%] transition-transform duration-300 ease-in-out sm:hidden overflow-y-auto">
