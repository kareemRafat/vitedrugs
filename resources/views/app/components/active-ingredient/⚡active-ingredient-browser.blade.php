                ...
                <div class="group bg-white dark:bg-slate-800 rounded-xl border border-neutral-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col relative overflow-hidden">
                    ...
                    <div class="p-5 pt-6 flex flex-col flex-1">
                        ...
                        <div class="bg-gradient-to-br from-brand/5 to-sky-50 dark:from-brand/10 dark:to-slate-700 -mx-5 -mt-6 px-5 pt-5 pb-4 mb-4 border-b border-brand/10 dark:border-slate-600">
                            <a href="{{ route('active-ingredients.show', $ingredient) }}" wire:navigate class="text-lg font-bold text-heading dark:text-white group-hover:text-brand dark:group-hover:text-sky-400 transition-colors leading-tight block min-h-[3.5rem] line-clamp-2">
                                {{ $ingredient->name }}
                            </a>

                            @if ($ingredient->name_ar && app()->getLocale() === 'ar')
                                <p class="text-sm text-body dark:text-slate-400 mt-1">{{ $ingredient->name_ar }}</p>
                            @endif
                        </div>
                    ...
                    {{-- Bottom action bar --}}
                    <a href="{{ route('active-ingredients.show', $ingredient) }}" wire:navigate class="border-t border-default-medium dark:border-slate-700 px-5 py-3.5 flex items-center justify-between text-sm font-medium text-brand hover:text-brand-strong dark:text-sky-400 dark:hover:text-sky-300 hover:bg-brand/5 dark:hover:bg-slate-700/50 transition-all group/action">
