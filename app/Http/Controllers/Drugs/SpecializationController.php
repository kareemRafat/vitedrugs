...
class SpecializationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('drugs.specializations.index', compact('groups'));
    }
    ...
    public function show(string $group)
    {
        ...
        return view('drugs.specializations.show', compact('group', 'species', 'diseases', 'products', 'articles', 'microorganisms'));
    }
